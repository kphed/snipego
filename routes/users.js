...
router.post('/send-message', function(req, res) {
  ...
  if (req.body.username === 'CSGO-FIGHT.COM' || req.body.username === 'CSGO-EASY' || req.body.username === 'STAY FROSTY!' || req.body.username === 'CSGOResort.com NO MIN BET' || req.body.username === 'KEy StakeCSGO.com' || req.body.username === 'SKINGABEN .com' || req.body.username === 'IceCream' || req.body.username === 'W4tchYourB4ck CSGODiceGame.com' || req.body.username === 'dELiciousz.!' || req.body.username === 'BOT Slayer' || req.body.username === 'Reachy') {
    console.log('SPAMMER');
