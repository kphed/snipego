...
router.post('/send-message', function(req, res) {
  ...
  if (req.body.username === 'CSGO-FIGHT.COM' || req.body.username === 'CSGO-EASY' || req.body.username === 'STAY FROSTY!' || req.body.username === 'CSGOResort.com NO MIN BET' || req.body.username === 'KEy StakeCSGO.com' || req.body.username === 'SKINGABEN .com' || req.body.username === 'IceCream') {
    console.log('SPAMMER');
